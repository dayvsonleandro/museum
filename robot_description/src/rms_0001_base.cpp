// #include "rms_0001_base.h"

// RmsBase::RmsBase() : linear_velocity_x_(0),
...
//     velocity_subscriber_ = nh_.subscribe("raw_vel", 50, &RmsBase::velCallback, this);
// }

// void RmsBase::velCallback(const Rms_msgs::Velocities &vel)
// {
